...
window.AMP_CONTENT = {
  specialties: [
    ...
    { id: "gi", label: "Gastroenterology", blurb: "Procedure and clinic mix with clear schedule preview." },
    ...
    { id: "neuro", label: "Neurology", blurb: "Still-there example: Baptist Health - Richmond, Pattie A. Clay (Richmond, KY)." },
  ...
  regions: [
    ...
    { id: "southeast", label: "Southeast", blurb: "Coastal and inland options with lifestyle preview.", states: ["AR", "LA", "MS", "AL", "TN", "KY", "GA", "FL", "SC", "NC", "VA", "WV"] },
  ...
  facilitySpecialtyRanks: {
    "fqhc": [
      ...
      { id: "dental", label: "Dentistry", blurb: "Still-there example: Winn Community Health Center (Winnfield, LA)." },
      { id: "obg", label: "Obstetrics & Gynecology", blurb: "Still-there example: Christ Community Health Services (Memphis, TN)." },
      { id: "internal_medicine_general", label: "Internal Medicine", blurb: "Still-there example: Central Counties Health Centers (Springfield, IL)." },
    ...
    "cah": [
      ...
      { id: "hospitalist_internal_medicine", label: "Hospitalist", blurb: "Still-there example: Baptist - Richmond (Richmond, KY)." },
      { id: "emergency_medicine", label: "Emergency Medicine", blurb: "24/7 ED — employed, locums, or mixed FM/EM." },
      { id: "surgery_general", label: "General Surgery", blurb: "Breadth specialty for critical access." },
      { id: "obg", label: "Obstetrics & Gynecology", blurb: "Only where they still deliver." },
      { id: "cards", label: "Cardiology", blurb: "Still-there example: Saint Francis Medical Center (Cape Girardeau, MO)." },
      { id: "nurse_practitioner_family_medicine_without_ob", label: "Family NP / PA", blurb: "Clinic or RHC advanced practice." },
      { id: "nurse_practitioner_emergency_medicine", label: "ED NP / PA", blurb: "Still-there NP example: Northern Cochise Community Hospital (Willcox, AZ)." },
    ],
    "community": [
      ...
      { id: "orthopedic_surgery_general", label: "Orthopedics", blurb: "Still-there example: Henry County Medical Center (Paris, TN)." },
      { id: "cards", label: "Cardiology", blurb: "Employed or visiting cardiology." },
      { id: "anesthesiology", label: "Anesthesiology", blurb: "Still-there example: Kansas Heart Hospital (Wichita, KS)." },
      { id: "gi", label: "Gastroenterology", blurb: "Still-there example: AdventHealth Medical Group (Tampa, FL)." },
    ],
    "system": [
      ...
      { id: "cards", label: "Cardiology", blurb: "Hard-to-fill procedural specialty." },
      { id: "orthopedic_surgery_general", label: "Orthopedic Surgery", blurb: "High-volume surgical hire." },
    ...
    "bh": [
      ...
      { id: "psychiatry_child_and_adolescent", label: "Child & Adolescent Psychiatry", blurb: "Still-there psychiatry example: Regional Medical Center (Anniston, AL)." },
      { id: "psychiatry_addiction_medicine", label: "Addiction Medicine", blurb: "Still-there psychiatry example: Regional Medical Center (Anniston, AL)." },
      { id: "psychiatry_geriatric", label: "Geriatric Psychiatry", blurb: "Still-there psychiatry example: Regional Medical Center (Anniston, AL)." },
    ...
    "group": [
      ...
      { id: "obg", label: "Obstetrics & Gynecology", blurb: "Women’s health in the group." },
      { id: "dermatology", label: "Dermatology", blurb: "Outpatient specialty demand." },
    ...
    "other": [
      ...
      { id: "hospitalist_internal_medicine", label: "Hospitalist", blurb: "High-volume hospital search." },
      { id: "obg", label: "Obstetrics & Gynecology", blurb: "Hard-to-fill women’s health." },
      { id: "psychiatry_general", label: "Psychiatry", blurb: "Behavioral health demand." },
      { id: "emergency_medicine", label: "Emergency Medicine", blurb: "ED coverage searches." },
      { id: "cards", label: "Cardiology", blurb: "Procedural specialty demand." },
    ],
  },
  jobs: [
    {
