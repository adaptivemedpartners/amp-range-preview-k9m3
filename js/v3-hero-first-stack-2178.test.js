...
function checkPage(rel) {
  ...
  assert(hero < finding && finding < stripAt && stripAt < bridge && bridge < steps && steps < row, rel + " headline, specialty strip, steps, then row2");
  assert(hero < eyebrow && eyebrow < place && place < sub && sub < finding && finding < rotator, rel + " stay line sits under the hero sub");
