...
var expected = [
  ["assets/partners/adventist-health.png?v=2175", "Adventist Health"],
  ["assets/partners/okpca.png?v=2175", "Oklahoma Primary Care Association"],
  ["assets/partners/tenet-health.png?v=2175", "Tenet Health"],
  ["assets/partners/chs.png?v=2175", "Community Health Systems"],
  ["assets/partners/tpca.png?v=2175", "Tennessee Primary Care Association"],
  ["assets/partners/shriners.png?v=2175", "Shriners Hospitals for Children"]
];
...
function checkPartners(rel) {
  ...
  assert(html.indexOf("amp-build 2175-ok-tn-pca-partners") !== -1, rel + " chip");
...
assert(app.indexOf('__AMP_BUILD = "2175-ok-tn-pca-partners"') !== -1, "app build stamp");
