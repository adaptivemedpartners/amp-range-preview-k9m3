...
assert(html.indexOf('href="css/site.css?v=2176"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2176"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2176"') !== -1, "rotator cache bust");
assert(html.indexOf("amp-build 2176-specialty-still-there-examples") !== -1, "chip");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2176") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2176") !== -1, "hiring photo");
