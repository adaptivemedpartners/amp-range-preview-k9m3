...
assert(html.indexOf('href="css/site.css?v=2186"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2186"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2186"') !== -1, "rotator cache bust");
assert(html.indexOf("amp-build 2186-specialty-ctx-photo-taller") !== -1, "chip");
...
assert(heroAt < stripAt && stripAt < bridgeAt && bridgeAt < stepsAt && stepsAt < rowAt, "hero, specialty strip, steps, then row2");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2186") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2186") !== -1, "hiring photo");
...
assert(css.indexOf("max-height: 220px") !== -1, "specialty stay story photo band taller (2186)");
assert(css.indexOf("height: 180px") !== -1, "specialty stay story photo height 180");
