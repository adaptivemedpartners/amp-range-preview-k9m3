...
assert(html.indexOf('href="css/site.css?v=2181"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2181"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2181"') !== -1, "rotator cache bust");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2181") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2181") !== -1, "hiring photo");
