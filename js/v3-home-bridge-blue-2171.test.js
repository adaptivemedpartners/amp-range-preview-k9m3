...
assert(html.indexOf('href="css/site.css?v=2174"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2174"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2174"') !== -1, "rotator cache bust");
assert(html.indexOf("amp-build 2174-facility-still-there-examples") !== -1, "chip");
assert(app.indexOf('__AMP_BUILD = "2174-facility-still-there-examples"') !== -1, "app build stamp");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2174") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2174") !== -1, "hiring photo");
