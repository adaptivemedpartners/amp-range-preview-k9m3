...
assert(html.indexOf('href="css/site.css?v=2177"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2177"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2177"') !== -1, "rotator cache bust");
assert(html.indexOf("amp-build 2177-zach-scope-strip") !== -1, "chip");
...
assert(bridgeAt < stepsAt && stepsAt < stripAt && stripAt < heroAt && heroAt < rowAt, "bridge, zach strip, hero, then row2");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2177") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2177") !== -1, "hiring photo");
