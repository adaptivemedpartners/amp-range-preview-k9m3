...
assert(html.indexOf('href="css/site.css?v=2171b"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2171b"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2171b"') !== -1, "rotator cache bust");
assert(html.indexOf("amp-build 2171-bridge-blue-stretch") !== -1, "chip");
assert(app.indexOf('__AMP_BUILD = "2171-bridge-blue-stretch"') !== -1, "app build stamp");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2171b") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2171b") !== -1, "hiring photo");
