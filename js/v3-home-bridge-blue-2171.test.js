...
assert(html.indexOf('href="css/site.css?v=2173"') !== -1, "css cache bust");
assert(html.indexOf('src="js/app.js?v=2173"') !== -1, "app cache bust");
assert(html.indexOf('src="js/hero-ret-rotator.js?v=2173"') !== -1, "rotator cache bust");
assert(html.indexOf("amp-build 2173-confirm-guide-name") !== -1, "chip");
...
assert(row.indexOf("amp-path-cand-nurses.jpg?v=2173") !== -1, "physician photo");
assert(row.indexOf("amp-path-client-hallway.jpg?v=2173") !== -1, "hiring photo");
