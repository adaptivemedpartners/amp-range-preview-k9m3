...
assert(app.indexOf('window.__AMP_BUILD = "2176-specialty-still-there-examples"') !== -1, "app build stamp");
...
assert(html.indexOf("?v=2176") !== -1, "cache bust");
...
assert(html.indexOf("assets/partners/okpca.png?v=2176") !== -1, "OK PCA logo kept");
assert(html.indexOf("assets/partners/tpca.png?v=2176") !== -1, "TN PCA logo kept");
