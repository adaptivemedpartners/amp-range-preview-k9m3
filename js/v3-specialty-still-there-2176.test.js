...
assert(app.indexOf('window.__AMP_BUILD = "2177-zach-scope-strip"') !== -1, "app build stamp");
...
assert(html.indexOf("?v=2177") !== -1, "cache bust");
...
assert(html.indexOf("assets/partners/okpca.png?v=2177") !== -1, "OK PCA logo kept");
assert(html.indexOf("assets/partners/tpca.png?v=2177") !== -1, "TN PCA logo kept");
