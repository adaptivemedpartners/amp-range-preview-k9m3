...
assert(html.indexOf("?v=2185") !== -1, "cache bust");
...
assert(html.indexOf("assets/partners/okpca.png?v=2185") !== -1, "OK PCA logo kept");
assert(html.indexOf("assets/partners/tpca.png?v=2185") !== -1, "TN PCA logo kept");
