...
function checkPage(rel) {
  ...
  assert(hero < finding && finding < stripAt && stripAt < steps && steps < row, rel + " place hero, stay line, Zach strip, steps, then row2");
  assert(steps !== -1 && stripAt < steps && steps < row, rel + " steps sit after the specialty strip");
