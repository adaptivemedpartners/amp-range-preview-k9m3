...
(function () {
  ...
  /* Imagine timeline: 0–1 aerial, 1–4 swoop, ~5.05 trailhead freeze.
     Bake + labels locked to the 5.05 frame. Pause THERE — sharp stop, no mid-zoom blur.
     (Mike 2026-09-07: never settle while the swoop is still moving.) */
  var SETTLE = 5.05;
  ...
  function trailheadBakeSrc(route) {
    var v = "1910";
    /* Same 5.05 bake phone + desktop — freeze frame match = no blur/pop. */
  ...
  function jobsMpcEmpty() {
    ...
    return "<article class=\"jobs-mpc-empty panel panel-glow\" aria-live=\"polite\"><span class=\"tag\">A quieter match path</span><h3>Nothing is posted for this cut yet.</h3><p>A guide can still check the wider bench and route a match if one fits your path.</p><p class=\"jobs-path-stamp\">Your path: " + path + "</p><div class=\"btn-row\"><button type=\"button\" class=\"btn btn-primary\" data-guide-whisper=\"1\">Talk to a guide</button><button type=\"button\" class=\"btn btn-ghost\" data-chat=\"talk\">Open the Mess</button></div></article>";
  }
