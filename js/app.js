...
(function () {
  "use strict";
  window.__AMP_BUILD = "2203-mi-dayload-support-worksheets";    /* Imagine winner lock 2026-09-09 ~12:49 CT: whole ~6s clip; HTML picker soft-fades late. */
  var SETTLE = 6.0;
  ...
  function paintV3Ctx(root, story) {
    ...
    if (media) {
      media.style.backgroundImage = "url('" + story.img + "?v=2195')";
