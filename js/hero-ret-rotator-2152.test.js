/* Node smoke: 2152 hero rotating retention card.
   Run: node js/hero-ret-rotator-2152.test.js */
var fs = require("fs");
...
function checkHtml(rel) {
  ...
  assert(html.indexOf("<!-- amp-build:2152-hero-rotating-ret-card -->") !== -1, rel + " missing 2152 stamp comment");
  assert(html.indexOf("amp-build 2152-hero-rotating-ret-card") !== -1, rel + " missing 2152 chip");
  assert(html.indexOf('href="css/site.css?v=2152"') !== -1, rel + " css not ?v=2152");
  assert(html.indexOf('src="js/app.js?v=2152"') !== -1, rel + " app.js not ?v=2152");
  assert(html.indexOf('src="js/hero-ret-rotator.js?v=2152"') !== -1, rel + " rotator js missing");
...
assert(app.indexOf('window.__AMP_BUILD = "2152-hero-rotating-ret-card"') !== -1, "app.js build stamp");
...
assert(rotator.indexOf("amp-build:2152-hero-rotating-ret-card") !== -1, "rotator missing 2152 stamp");
...
assert(css.indexOf("amp-build:2152-hero-rotating-ret-card") !== -1, "css missing 2152 stamp");
...
console.log("hero-ret-rotator-2152.test.js: ok");
